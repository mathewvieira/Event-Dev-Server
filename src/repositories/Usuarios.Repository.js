import getPool from "../shared/utils/pool.Utils";
...
class UsuariosRepository {
    ...
    async update(id, data) {
        const [result] = await getPool.execute('UPDATE usuario SET email = ?, senha = ?, role = ? WHERE id = ?', [data.email, data.senha, data.role, id]);
